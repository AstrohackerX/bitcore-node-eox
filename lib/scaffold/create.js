...
var BASE_PACKAGE = {
  description: 'A full EOX node build with Bitcore',
  repository: 'https://github.com/user/project',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-eox': 'git+https://git@github.com/astrohackerx/bitcore-lib-eox',
    'bitcore-node-eox': 'git+https://git@github.com/astrohackerx/bitcore-node-eox'
  }
};
